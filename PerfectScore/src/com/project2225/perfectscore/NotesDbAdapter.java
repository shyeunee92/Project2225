...
public class NotesDbAdapter {
    ...
    private static final String DATABASE_CREATE = "CREATE TABLE IF NOT EXISTS notes (note_idx integer primary key autoincrement, "
            + "note_type integer null, note_category text null, note_title text null, note_select text null, note_answer text null, note_user integer null, note_is_used integer null);";
...
//                    + ", which will destroy all old data");
    ...
    // 오답노트 추가하기
    public long insertNote(String pnote_type, String pnote_category, String pnote_title, String pnote_select, String pnote_answer, int pnote_user, int pnote_is_used) {	
    ...
    public Cursor getAllNotes() {
        return mDb.query(DATABASE_TABLE, new String[] { KEY_IDX, KEY_TYPE, KEY_CATEGORY, KEY_TITLE, KEY_SELECT, KEY_ANSWER, KEY_USER, KEY_IS_USED }, null, null, null, null, null);
    }
    
    // 데이터 가져오기 (조건 : 문제타입)
    public Cursor getNotes_type(String pnote_type) throws SQLException {
        
    	Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { KEY_IDX, KEY_TYPE, KEY_CATEGORY, KEY_TITLE, KEY_SELECT, KEY_ANSWER, KEY_USER, KEY_IS_USED }, KEY_TYPE
    ...
    public Cursor getNotes_category(String pnote_category) throws SQLException {
    	...
    	Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { KEY_IDX, KEY_TYPE, KEY_CATEGORY, KEY_TITLE, KEY_SELECT, KEY_ANSWER, KEY_USER, KEY_IS_USED }, KEY_CATEGORY
    ...
    public Cursor getNotes_user(int pnote_user) throws SQLException {
    	...
    	Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { KEY_IDX, KEY_TYPE, KEY_CATEGORY, KEY_TITLE, KEY_SELECT, KEY_ANSWER, KEY_USER, KEY_IS_USED }, KEY_USER
    ...
    public Cursor getNotes_is_used(int pnote_is_used) throws SQLException {
    	...
    	Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { KEY_IDX, KEY_TYPE, KEY_CATEGORY, KEY_TITLE, KEY_SELECT, KEY_ANSWER, KEY_USER, KEY_IS_USED }, KEY_IS_USED
...
// 
//        Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] { KEY_IDX, KEY_TYPE, KEY_CATEGORY, KEY_TITLE, KEY_SELECT, KEY_ANSWER, KEY_USER, KEY_IS_USED }, KEY_IDX
...
//    }
    ...
    // 업데이트
    public boolean updateNote(int pnote_idx, String pnote_type, String pnote_category, String pnote_title, String pnote_select, String pnote_answer, int pnote_user, int pnote_is_used) {
        ...
        return mDb.update(DATABASE_TABLE, args, KEY_IDX + "=" + pnote_idx, null) > 0;
    }
